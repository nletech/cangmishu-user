    ...
    <el-row :class="$style.staffAdd_main">
      ...
      <el-col :span="10" :offset="6">
        ...
        >
          ...
          >
            <el-input
              v-model="staff_info_form_changed.name"
            ></el-input>
          </el-form-item>
          ...
          >
            <el-input
              v-model="staff_info_form_changed.phone"
            ></el-input>
          </el-form-item>
          <el-form-item
            label="备注"
          ...
          >
            <el-input
              type="textarea"
              v-model="staff_info_form_changed.remark"
            ></el-input>
          </el-form-item>
          <el-form-item>
            <el-col :span="2" :offset="8">
              <el-button
                type="success"
                @click="submit_staff_info_changed"
              >
                保存
              </el-button>
            </el-col>
...
export default {
  ...
  data() {
    return {
      imageUrl: '',
      staff_info_form_changed: { // 员工信息表单
        nickname: '',
        user_id: '',
        name: '',
        email: '',
  ...
  methods: {
    ...
    submit_staff_info_changed() {
      this.$confirm('确认修改?', '提示', {
        ...
        .then(() => {
          // 推送员工信息
          $http.editStaffInfo(this.$route.params.user_id, this.staff_info_form_changed)
            .then((res) => {
              // 处理添加成功
              if (res.status === 0) {
                // 显示成功消息
