  ...
  <div class="goodsAlarm">
    <mdoel-form>
      <el-form slot="left" label-width="120px" :rules="rules" :model="form" ref="form">
        <el-form-item :label="$t('warningEmail')" prop="warning_email">
          <el-row>
            <el-col :span="8">
              <el-input
        ...
        <el-form-item :label="$t('categoryManagement')">
          <el-table
            ...
            style="width: 100%"
          >
            <el-table-column align="center" header-align="center" type="index" width="55px;">
            </el-table-column>
            <el-table-column
            ...
            >
              <template slot-scope="scope">
                <el-input-number :min="1" size="small" v-model="scope.row.warning_stock">
                </el-input-number>
              </template>
            </el-table-column>
          </el-table>
...
export default {
  ...
  methods: {
    Warning() {
      $http.Warning({ warehouse_id: this.warehouseId }).then(res => {
